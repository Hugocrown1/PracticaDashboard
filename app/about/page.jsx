    ...
    <div className="text-center items-center grid grid-cols-2 justify-center h-screen ">
      ...
      <div className="text-left gap-y-4 flex flex-col h-full w-full px-8  justify-center items-center">
        <div>
          ...
          <p className={`text-2xl font-semibold ${lato.className}`}>
            Hola, mi nombre es{" "}
            <span className="text-[#00b4d8]">Hugo Corona</span> y soy un
            desarrollador web originario de{" "}
            <span className="text-[#00b4d8]">Ensenada, Baja California</span>{" "}
          </p>
          <br />
          <p className={`${latoLight.className} text-lg`}>
            Cuento con experiencia en el desarrollo de aplicaciones y soluciones
            tecnológicas. Enfocado tanto el desarrollo frontend como backend,
            con competencias en lenguajes como JavaScript y Java. Comprometido
            con la mejora continua y la adaptación a nuevas tecnologías. Listo
            para contribuir y resolver desafíos en entornos tecnológicos
            diversos.
          </p>
          ...
          <div className="my-4 flex flex-row items-center justify-center gap-x-14">
            ...
            <a
              ...
              href="https://www.linkedin.com/in/hugo-corona-62589327a/"
            >
      ...
      <div className="bg-[#003459] h-full items-center justify-center flex">
        <div className="mx-auto p-4 rounded-full bg-[#00A8E8] shadow-lg w-fit animate-float">
          <div
            className=" bg-cover bg-center bg-no-repeat  bg-[url(https://i.pinimg.com/1200x/6f/59/6d/6f596de33c9c7f97ac41c1f1c0596695.jpg)]
